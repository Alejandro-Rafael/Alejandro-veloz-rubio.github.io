...
function delete_area(id_area_delete){
    ...
    fetch(`https://incidenciakarmina-production.up.railway.app/api/Areas_h/${id_area_delete}`,{
        method:'DELETE',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
...
function dispo_g(area_x){
    ...
    fetch(`https://incidenciakarmina-production.up.railway.app/api/Areas_h/dipo_area/${area}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
